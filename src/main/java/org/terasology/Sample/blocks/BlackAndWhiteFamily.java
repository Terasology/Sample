...
public class BlackAndWhiteFamily extends UpdatesWithNeighboursFamily {
    ...
    public BlackAndWhiteFamily(BlockUri blockUri, List<String> categories, Block archetypeBlock, TByteObjectMap<Block> blocks) {
