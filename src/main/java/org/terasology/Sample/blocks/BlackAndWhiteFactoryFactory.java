...
@RegisterBlockFamilyFactory("BlackAndWhite")
@RegisterSystem(RegisterMode.AUTHORITY)
public class BlackAndWhiteFamilyFactory extends BaseComponentSystem implements BlockFamilyFactory {
    ...
    public BlackAndWhiteFamilyFactory() {
    }
    ...
    public BlockFamily createBlockFamily(BlockFamilyDefinition definition, BlockBuilderHelper blockBuilder) {
        ...
        return new BlackAndWhiteFamily(blockUri, definition.getCategories(),
        ...
        for (Side side : Side.values()) {
            ...
            if (worldProvider.isBlockRelevant(neighborLocation)) {
                ...
                if (blockFamily instanceof BlackAndWhiteFamily) {
                    BlackAndWhiteFamily neighboursFamily = (BlackAndWhiteFamily) blockFamily;
